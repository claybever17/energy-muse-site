...
- The quiz page's bag uses **name-derived ids** while shop/intention pages use slugs — the same
  product added from both surfaces double-counts. Known bug, unfixed (fold into PDP work).
