...
'.embag-x{background:none;border:1px solid #EAE3D6;border-radius:3px;width:36px;height:36px;font-size:19px;',
...
'.embag-rm{background:none;border:none;color:#8D8778;font-size:11px;letter-spacing:.08em;text-transform:uppercase;',
